...
namespace ChildcareWorldwide.Integration.Subscriber
{
    public class Worker : BackgroundService
    {
        ...
        private Task StartSubscriberWithErrorHandlingAsync(
            ...
            Func<PubsubMessage, CancellationToken, Task<ProcessMessageResult>> handler)
        {
            return m_googleCloudPubSubService.StartSubscriberAsync(config.Subscription, async (msg, cancellationToken) =>
            {
